<template>
  <div class="min-h-screen bg-[#1E1B18] text-[#E8E2D9] p-4">
    <header class="flex justify-between items-center mb-6">
      <div>
        <h1 class="text-2xl font-bold text-[#8B1F14]">COMMANDES</h1>
      </div>
    </header>

    <div v-if="loading" class="text-center text-[#6B6B6B]">loading orders...</div>
    ...
    <div v-else class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
        <div class="flex justify-between items-start mb-3">
          <div>
            <h2 class="text-lg font-bold">Table {{ order.tableNumber }}</h2>
        ...
        <div class="space-y-2">
          ...
          >
            ...
            <span class="text-xs font-medium" :class="itemStatusClass(item.status)">
